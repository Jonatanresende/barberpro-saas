...
export const WhatsAppIcon = ({ className = 'w-6 h-6' }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.74.45 3.38 1.24 4.84l-1.28 4.68 4.8-1.26c1.42.74 3.02 1.18 4.65 1.18h.01c5.46 0 9.91-4.45 9.91-9.91s-4.45-9.91-9.92-9.91zm4.22 11.38c-.22.38-.79.7-1.33.85-.54.15-1.08.2-2.52-.38-1.44-.58-2.6-1.24-3.58-2.23-.98-.98-1.64-2.14-2.23-3.58-.58-1.44-.53-1.98-.38-2.52.15-.54.48-1.1.85-1.33.38-.22.79-.27 1.13-.27.3 0 .58.05.81.38.23.33.85 1.33.94 1.43s.18.22.27.35c.09.13.13.22.05.4-.08.18-.18.3-.3.43-.13.13-.25.28-.38.38-.12.1-.2.22-.08.42.12.2.6 1.03 1.28 1.7.68.68 1.5.98 1.7 1.1.2.12.32.1.42-.08.1-.12.25-.28.38-.38.13-.1.25-.18.43-.1.18.08.98.45 1.18.53s.33.13.38.2c.04.08.04.5-.18.88z"/>
    </svg>
);
