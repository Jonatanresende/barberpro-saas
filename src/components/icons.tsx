...
export const WhatsAppIcon = ({ className = 'w-6 h-6' }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm3.22 13.88c-.22.12-1.33.66-1.54.73-.21.07-.36.11-.51-.11-.15-.22-.58-.73-.71-.89-.13-.16-.26-.18-.48-.06-.22.12-1.38.69-1.59.81-.21.12-.36.18-.51.06-.15-.12-1.05-.65-2-1.65s-1.5-1.84-1.65-2.14c-.15-.3-.04-.46.1-.6.12-.12.27-.33.41-.49.14-.16.18-.27.27-.45.09-.18.04-.33-.02-.45-.06-.12-.51-1.23-.7-1.62-.18-.39-.37-.33-.51-.33h-.47c-.15 0-.38.05-.58.24-.2.19-.78.76-.78 1.85s.8 2.15.91 2.32c.11.17 1.57 2.46 3.86 3.42.55.23.98.37 1.32.47.55.17 1.05.14 1.44.09.44-.06 1.33-.55 1.52-1.08.19-.53.19-1 .13-1.08-.06-.08-.21-.13-.45-.24z"/>
    </svg>
);
