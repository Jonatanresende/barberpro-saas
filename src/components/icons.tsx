...
export const WhatsAppIcon = ({ className = 'w-6 h-6' }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2C6.477 2 2 6.477 2 12c0 3.018 1.28 5.74 3.35 7.65l-1.3 4.75 4.9-1.28c1.79.97 3.85 1.5 6.05 1.5h.01c5.523 0 10-4.477 10-10S17.523 2 12 2zm4.8 14.8c-.21.12-.76.38-1.33.15-.57-.23-1.14-1.04-1.36-1.27s-.22-.23-.45 0c-.23.23-.9 1.04-1.1 1.24s-.38.23-.7.12c-.32-.12-1.33-.49-2.53-1.56-1.2-1.07-2-2.38-2.22-2.78s-.05-.38.12-.5c.14-.14.32-.38.48-.57.17-.2.23-.35.35-.57.12-.23 0-.45-.12-.68s-1.1-2.65-1.5-3.6c-.4-.95-.81-.81-.81-.81-.35 0-.7.12-.93.12s-.68.35-1.04 1.04c-.35.7-1.36 3.28-1.36 5.23 0 1.95 1.38 6.08 1.58 6.5s2.75 4.23 6.75 5.93c4 1.7 4 1.18 4.73 1.18.73 0 2.28-.95 2.6-1.8.32-.85.32-1.58.23-1.8s-.35-.23-.76-.45z"/>
    </svg>
);
