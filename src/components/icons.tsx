...
export const WhatsAppIcon = ({ className = 'w-6 h-6' }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 144 144" fill="currentColor">
        <path d="M88.43,72.21c-0.5,-0.25 -2.98,-1.47 -3.44,-1.64c-0.46,-0.17 -0.79,-0.25 -1.12,0.25c-0.33,0.5 -1.3,1.64 -1.6,1.97c-0.3,0.33 -0.59,0.37 -1.08,0.12c-0.5,-0.25 -2.15,-0.79 -4.09,-2.52c-1.51,-1.35 -2.53,-3.01 -2.97,-3.53c-0.44,-0.52 -0.04,-0.8 0.22,-1.08c0.24,-0.25 0.5,-0.62 0.75,-0.92c0.25,-0.3 0.37,-0.5 0.54,-0.83c0.17,-0.33 0.09,-0.62 -0.04,-0.87c-0.13,-0.25 -1.12,-2.71 -1.53,-3.69c-0.4,-0.95 -0.82,-0.81 -1.12,-0.83c-0.28,-0.02 -0.59,-0.02 -0.9,-0.02c-0.31,0 -0.82,0.12 -1.25,0.62c-0.43,0.5 -1.53,1.5 -1.53,3.65c0,2.15 1.57,4.24 1.79,4.57c0.22,0.33 3.05,4.65 7.41,6.55c1.04,0.46 1.86,0.73 2.5,0.94c1.11,0.37 2.13,0.32 2.94,0.19c0.89,-0.15 2.53,-1.03 2.89,-2.04c0.36,-1.01 0.36,-1.88 0.25,-2.04c-0.11,-0.16 -0.43,-0.25 -0.92,-0.5z" />
    </svg>
);
